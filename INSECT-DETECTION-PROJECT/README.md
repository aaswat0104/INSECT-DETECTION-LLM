# 🪰 TJL Insect Detection & Analysis System  
...
The **TJL Insect Detection & Analysis System** addresses these limitations by combining **computer vision, sensor integration, and AI-driven analysis** into a single intelligent platform.  
...
```
git clone https://github.com/tjlksa25-debug/TJL-INSECT-DETECTION-PROJECT.git
cd TJL-INSECT-DETECTION-PROJECT
